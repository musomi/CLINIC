    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <a href="/UserProfile/{{Auth::user()->user_id}}"><img alt="image" class="rounded-circle" style="width:35%;height:35%" src="{{asset('images/'.Auth::user()->image)}}"/></a>
                ...
                <li>
                    <a href="/UserCategories"><i class="fa fa-diamond"></i> <span class="nav-label">User Category</span></a>
                </li>
                @endif
                <li>
                    <a href="/NewPatient"><i class="fa fa-diamond"></i> <span class="nav-label">New Patient</span></a>
                </li>
                @if(App\Category_permission::has_perm(array(1)))
                <li>
                  <a type="submit" href="/View/{{Auth::user()->user_id}}/Clients"><i class="fa fa-diamond"></i> <span class="nav-label">Manage Users</span></a>
              </li>
                @endif
                <li>
                <a href="/AllPatients"><i class="fa fa-diamond"></i> <span class="nav-label">Patients</span></a>
              </li>
            </ul>
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    <div class="title-action">
                        ...
                        <a href="/PrintPatient/{{$patient->patient_id}}/Invoice" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Invoice </a>
                    </div>
                </div>
                @else
                <div class="col-sm-4">
            ...
            <div class="footer">
                ...
                <div>
                    <strong>Copyright</strong> Example Clinic &copy; {{date('year')}}
                </div>
            </div>
